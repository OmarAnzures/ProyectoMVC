                ...
                <div class="card" style="border-radius: 1rem;">
                    <div class="row g-0">
                        <div class="col-md-6 col-lg-5 d-none d-md-block">
                            <img src="/Nolas/img/login.jpg" alt="login form" class="img-fluid" style="border-radius: 1rem 0 0 1rem; height: 550px;" />
                        </div>
                        <div class="col-md-6 col-lg-7 d-flex align-items-center">
                            <div class="card-body p-4 p-lg-5 text-black">
                                <form id="loginForm" action="/Nolas/conexion/session.php" method="post">
                                    <div class="text-center mb-4">
                                        <img src="/Nolas/img/logo.png" alt="Academy UTP Logo" class="img-fluid" style="max-width: 200px; height: auto; border-radius: 50%;">
                                    </div>
                                    <h5 class="text-center fw-normal mb-4" style="letter-spacing: 1px;">Inicia sesión en tu cuenta</h5>
                                    <div class="mb-4">
                                    ...
                                    <div class="mb-3 text-center">
                                        <a class="small text-muted" href="/Nolas/vista/recuperarcontr.php">¿Olvidaste tu contraseña?</a>
                                    </div>
                                    <div class="mb-4 text-center" style="color: #393f81;">
                                        ¿No tienes una cuenta? <a href="/Nolas/vista/formulario.php" class="text-decoration-none">Regístrate aquí</a>
                                    </div>
...
<script>
    // Llama a la función para mostrar el modal cuando se envíe el formulario
